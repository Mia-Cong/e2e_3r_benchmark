...
# Example usage
pickle_file_path = "/ssd2/wenyan/3r_benchmark/robustmvd/rmvd/data/sample_lists/scannet.robustmvd.mvd.pickle"
dest_root = "/ssd2/wenyan/3r_benchmark/datasets/RobustMVD_mvdsplit/scannet"
source_root = "/ssd2/wenyan/3r_benchmark/datasets/RobustMVD/scannet"  # Root directory of the source dataset
