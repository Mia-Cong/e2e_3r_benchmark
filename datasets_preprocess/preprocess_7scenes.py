...
Parallel(n_jobs=7, verbose=0)(map(delayed(process_scene), [os.path.join(src_folder, scan_name) for scan_name in ['chess', 'fire', 'heads', 'office', 'pumpkin', 'redkitchen', 'stairs']]))