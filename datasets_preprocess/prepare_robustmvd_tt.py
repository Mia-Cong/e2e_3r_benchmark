...
# Example usage
pickle_file_path = "/ssd2/wenyan/3r_benchmark/robustmvd/rmvd/data/sample_lists/tanks_and_temples.robustmvd.mvd.pickle"
dest_root = "/ssd2/wenyan/3r_benchmark/datasets/RobustMVD_mvdsplit/tanks_and_temples"
source_root = "/ssd2/wenyan/3r_benchmark/datasets/RobustMVD/tanks_and_temples"  # Root directory of the source dataset
